...
//               aria-hidden
//               style={{
//                 position: "absolute", top: 64, left: 32, right: 32, height: 2,
...
//               flexShrink: 0,
//               padding: "clamp(48px, 7vh, 100px) 32px clamp(20px, 3vh, 40px)",
...
//               style={{
//                 display: "flex", gap: 20,
//                 paddingLeft: 32, paddingRight: 112,
//                 willChange: "transform",
//                 alignItems: "stretch",
//               }}
//             >
...
//         {/* ── STUDIO / PHILOSOPHY ── */}
//         <section id="studio" style={{ padding: "160px 32px", borderTop: "1px solid rgba(0,0,0,0.06)" }}>
...
//         {/* ── TESTIMONIALS ── */}
//         <section style={{ padding: "160px 32px", background: "#f5f5f4", borderTop: "1px solid rgba(0,0,0,0.06)" }}>
...
//           <div style={{ maxWidth: 1320, margin: "0 auto 56px", padding: "0 32px", display: "flex", justifyContent: "space-between", alignItems: "end", gap: 40, flexWrap: "wrap" }}>
//             <div>
//               <h2
//                 style={{
//                   fontFamily: "'Space Grotesk', sans-serif",
...
//         {/* ── CTA ── */}
//         <section id="contact" style={{ padding: "0 32px 80px", borderTop: "1px solid rgba(0,0,0,0.06)", paddingTop: 80 }}>
//           <div
//             id="cta-inner"
//             style={{
...
//         {/* ── FOOTER ── */}
//         <footer style={{ padding: "60px 32px 40px", borderTop: "1px solid rgba(0,0,0,0.06)" }}>
//           <div style={{ maxWidth: 1320, margin: "0 auto" }}>
//             {/* Big wordmark */}
//             <div
//               style={{
...
//               const collapsedOpacity = Math.max(0, 1 - eased * 2);
//               const expandedOpacity  = Math.max(0, (eased - 0.5) * 2);
...
const TESTIMONIALS = [
  ...
  {
    quote:
      "From week one, they embedded like an internal team. They turned our messy scope into a focused product plan and shipped milestones predictably every Friday.",
    name: "David Romero",
    title: "Head of Product, AtlasPay",
    initials: "DR",
  },
  {
    quote:
      "Their backend and platform decisions gave us confidence to scale aggressively. Uptime improved, deploys got safer, and our team moved twice as fast.",
    name: "Amina Hassan",
    title: "Engineering Director, LoopMarket",
    initials: "AH",
  },
];
...
export default function HomePage() {
  ...
  // Testimonials carousel — rotate every 8s
  useEffect(() => {
    const id = setInterval(() => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className="cap-slat-expanded"
                      style={{
                        /* ABSOLUTE + fixed width = content never reflows during collapse.
                           The content sits anchored to the LEFT of the slat; as the slat
                           shrinks around it, the content keeps its expanded dimensions
                           and simply fades out. No line-wrapping jank. overflow:hidden
                           on the parent slat clips anything that would spill over. */
                        position: "absolute",
