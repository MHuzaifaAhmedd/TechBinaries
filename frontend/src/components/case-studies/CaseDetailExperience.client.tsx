...
import { caseStudyCoverStyle } from "@/lib/case-studies";
    ...
    <div ref={rootRef} className="cd-root">
      ...
      <section ref={heroRef} className="cd-hero">
        <div
          ...
          style={caseStudyCoverStyle(c.cover, 135)}
        >
      ...
      <section ref={processSectionRef} className="cd-process">
        <div className="cd-process__header">
          ...
          <div className="cd-process__progress">
            ...
            return (
              <figure key={i} className="cd-showcase__fullbleed">
                <div
                  ...
                  style={caseStudyCoverStyle(v.src, 130 + i * 20)}
                >
              ...
              <div key={i} className="cd-showcase__split">
                <div className="cd-showcase__split-media">
                  <div
                    ...
                    style={caseStudyCoverStyle(v.src, 140 + i * 12)}
                  />
                </div>
              ...
              <div key={i} className="cd-showcase__mockup-wrap">
                <div className="visual-mockup cd-showcase__mockup">
                  <div className="cd-showcase__mockup-browser">
                    ...
                    <div
                      className="cd-showcase__mockup-content"
                      style={caseStudyCoverStyle(v.src, 160)}
                    />
                  </div>
                  <div className="cd-showcase__mockup-phone">
                    <div
                      className="cd-showcase__mockup-screen"
                      style={caseStudyCoverStyle(v.src, 180)}
                    />
                  </div>
                </div>
          ...
          return (
            <figure key={i} className="cd-showcase__video">
              <div
                ...
                style={caseStudyCoverStyle(v.poster ?? v.src, 120)}
              >
      ...
      <section ref={resultsRef} className="cd-results">
        ...
        <div className="cd-slider">
          ...
          >
            <div
              className="cd-slider__after"
              style={caseStudyCoverStyle(c.beforeAfter?.after, 135)}
            />
            <div
              className="cd-slider__before"
              style={caseStudyCoverStyle(c.beforeAfter?.before, 120)}
            />
      ...
      <section className="cd-next">
        ...
        >
          <div
            ...
            style={caseStudyCoverStyle(next.cover, 135)}
          >
...
const styles = `
  ...
  .cd-metrics__bar {
    ...
    height: 100%;
    width: 100%;
    background: linear-gradient(to right, #fafaf9, rgba(255, 255, 255, 0.35));
  ...
  .cd-process__header {
    max-width: 1280px;
    margin: 0 auto;
    padding: clamp(80px, 12vh, 120px) 24px 32px;
  }
  .cd-process__eyebrow {
    margin: 0 0 16px;
    font-family: var(--font-body);
