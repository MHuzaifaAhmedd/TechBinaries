...
//       // Cards reveal — each card animates with text cascade
...
//           /* Prevent italic glyph edges from being clipped per character */
//           overflow: visible;
...
//           /* Thick from outer edge, tapered toward center */
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Mobile — capabilities switches to flat stacked layout */
